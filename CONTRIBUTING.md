Contributing to ShareDexCoin Core
==================================

The ShareDexCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ShareDexCoin Core project, and is not to be
confused with overall ShareDexCoin Network Protocol consensus changes.

Whether a pull request is merged into ShareDexCoin Core rests with the project merge
...
Patches that change ShareDexCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ShareDexCoin consensus, it must have been
...
The project leader is the release manager for each ShareDexCoin Core release.
