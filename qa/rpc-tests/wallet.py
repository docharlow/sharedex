...
#   c) node1 mines 32 blocks, so now node 0 has 500000SDC, node 1 has 4250SDC, node2 has none.
#   d) node0 sends 601 SDC to node2, in two transactions (301 SDC, then 300 SDC).
