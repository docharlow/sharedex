...
/** Utility functions used by the ShareDexCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SDC addresses in monospace font
...
// Parse "sharedexcoin:" URI into recipient object, return true on successful parsing
