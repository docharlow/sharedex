                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ShareDexCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SDC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sharedexcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ShareDexCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ShareDexCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ShareDexCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SDC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SDC addresses"));
    ...
    openAction->setStatusTip(tr("Open a sharedexcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ShareDexCoin Core help message to get a list with possible ShareDexCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ShareDexCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ShareDexCoin network", "", count));
}
...
{
    QString strTitle = tr("ShareDexCoin Core"); // default title
