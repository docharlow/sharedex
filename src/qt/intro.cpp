...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ShareDexCoin Core"),
     ...
     * override -datadir in the sharedexcoin.conf file in the default data directory
     * (to be consistent with sharedexcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
