...
#if defined(NDEBUG)
#error "ShareDexCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in usdc) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < Params().LAST_POW_BLOCK())
        nSubsidy = 25000 * COIN;
          ...
          nSubsidy = 1 * COIN;
      else if (nHeight > 250 && nHeight <= 400)
          nSubsidy = 1.50 * COIN;
      else if (nHeight > 400 && nHeight <= 500)
          nSubsidy = 1.75 * COIN;
      else if (nHeight > 500 && nHeight <= 225650)
          nSubsidy = 40 * COIN;
      else if (nHeight > 225650 && nHeight <= 751300)
          nSubsidy = 32.8 * COIN;
      else if (nHeight > 751300 && nHeight <= 1276950)
          nSubsidy = 26.9 * COIN;
      else if (nHeight > 1276950 && nHeight <= 1802600)
          nSubsidy = 22.06 * COIN;
      else if (nHeight > 1802600 && nHeight <= 2328250)
          nSubsidy = 18.08 * COIN;
      else if (nHeight > 2328250 && nHeight <= 2853900)
          nSubsidy = 14.82 * COIN;
      else if (nHeight > 2853900 && nHeight <= 3379550)
          nSubsidy = 12.16 * COIN;
      else if (nHeight > 3379550 && nHeight <= 3905200)
          nSubsidy = 9.98 * COIN;
      else if (nHeight > 3905200 && nHeight <= 4430850)
          nSubsidy = 8.18 * COIN;
      else if (nHeight > 4430850 && nHeight <= 4956500)
          nSubsidy = 6.7 * COIN;
      else if (nHeight > 4956500 && nHeight <= 5482150)
          nSubsidy = 5.5 * COIN;
      else if (nHeight > 5482150 && nHeight <= 6007800)
          nSubsidy = 4.5 * COIN;
      else if (nHeight > 6007800 && nHeight <= 6533450)
          nSubsidy = 3.7 * COIN;
      else
        nSubsidy = 2 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    ret = blockValue * 0.75; // 85% of block reward
...
{
    RenameThread("sharedexcoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SDC: We use certain sporks during IBD, so check to see if they are
