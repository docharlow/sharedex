...
// Copyright (c) 2017 The ShareDexCoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000c43dfd01f407f75d25d926ad771ed3d9535487d1d9fcf0950b6ba901922"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1541029232, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // ShareDexCoin: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for SDC
         ...
         */
        const char* pszTimestamp = "ShareDexCoin Launches November 2018";
...
*/
		...
		assert(hashGenesisBlock == uint256("00000c43dfd01f407f75d25d926ad771ed3d9535487d1d9fcf0950b6ba901922"));
        	assert(genesis.hashMerkleRoot == uint256("5f678b65bfa8994a77b190c35499803962ed02e32a77f95ef5a7bb1800ea9633"));
        ...
        // ShareDexCoin private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // ShareDexCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // ShareDexCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // ShareDexCoin BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ShareDexCoin: 1 day
        nTargetSpacing = 2 * 60;  // ShareDexCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c43dfd01f407f75d25d926ad771ed3d9535487d1d9fcf0950b6ba901922"));

        vFixedSeeds.clear();
        vSeeds.clear();

        // Testnet ShareDexCoin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet ShareDexCoin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet ShareDexCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet ShareDexCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
