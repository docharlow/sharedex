...
In order to support loading of multiple wallets in sharedexcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sharedexcoin.cpp.
...
Changes to sharedexcoin.cpp
----------------------
sharedexcoin.cpp is the entry point into sharedexcoin-qt, and as such, will require some minor modifications to provide hooks for
