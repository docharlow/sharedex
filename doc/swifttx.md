...
This mechanism has been integrated into Bitcore-Node-ShareDexCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sharedexcoin/insight-api-sharedexcoin#web-socket-api](https://github.com/sharedexcoin/insight-api-sharedexcoin#web-socket-api)
* API: [https://github.com/sharedexcoin/insight-api-sharedexcoin#swifttx-transactions](https://github.com/sharedexcoin/insight-api-sharedexcoin#swifttx-transactions)
...
By default, the ShareDexCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ShareDexCoin Core daemon:
