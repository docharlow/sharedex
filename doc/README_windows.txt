...
Intro
-----
ShareDexCoin (SDC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. ShareDexCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run sharedexcoin-qt.exe.

ShareDexCoin Core is the original ShareDexCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of ShareDexCoin transactions;
